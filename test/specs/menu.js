...
describe('Tests for Menu functionality', () => {
    ...
    xit('Check the functionality of the "Tote Bags" category and "Bags" subcategory', async() =>{
        await mainpage.clickOpenMenuButton();
    ...
    xit('Check the functionality of the "Satchel" category and "Bags" subcategory', async() =>{
        await mainpage.clickOpenMenuButton();
    ...
    xit('Check the functionality of the "Travel Bags" category and "Bags" subcategory', async() =>{
        await mainpage.clickOpenMenuButton();
